...
class Bijou
{
    ...
    #[ORM\Column]
    #[Groups(['bijou:list','bijou:item','location:list','location:item','categorie:list','categorie:item'])]
    ...
    #[ORM\OneToMany(mappedBy: 'bijous', targetEntity: Location::class)]
    ...
    public function removeLocation(Location $location): static
    {
        if ($this->locations->removeElement($location)) {
            ...
            if ($location->getBijous() === $this) {
                $location->setBijous(null);
            }
        }
